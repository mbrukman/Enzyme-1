...
typedef struct EnzymeOpaqueAAResults *EnzymeAAResultsRef;
...
LLVMValueRef EnzymeCreatePrimalAndGradient(
    ...
    struct CFnTypeInfo typeInfo, bool *_uncacheable_args,
    size_t uncacheable_args_size, EnzymeAugmentedReturnPtr augmented,
    bool AtomicAdd, bool PostOpt);
...
EnzymeAugmentedReturnPtr EnzymeCreateAugmentedPrimal(
    ...
    struct CFnTypeInfo typeInfo, bool *_uncacheable_args,
    size_t uncacheable_args_size, bool forceAnonymousTape, bool AtomicAdd,
    bool PostOpt);
